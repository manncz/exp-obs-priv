...
save(out.p10, noise.p10, gmse.p10, file = "sim-out/sim-result-10.Rdata")
```
...
save(out.p20, noise.p20, gmse.p20, file = "sim-out/sim-result-20.Rdata")
```
...
save(out.p50, noise.p50, gmse.p50, file = "sim-out/sim-result-50.Rdata")
```
