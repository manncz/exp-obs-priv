---
title: "Run Precision Simulations with Regression Estimator Changing P"
...
stopImplicitCluster()
save(sim.list.10, file = "sim-out/sim-result-raw-10.Rdata")
```
...
save(out.p10, gfnorm.p10, gspectral.p10, betapred.p10, file = "sim-out/var-m10/sim-result-10.Rdata")
...
stopImplicitCluster()
save(sim.list.20, file = "sim-out/sim-result-raw-20.Rdata")
```
...
save(out.p20, gfnorm.p20, gspectral.p20, betapred.p20, file = "sim-out/var-m10/sim-result-20.Rdata")
```
...
save(sim.list.50, file = "sim-out/sim-result-raw-50.Rdata")
```
...
save(out.p50, gfnorm.p50, gspectral.p50, betapred.p50, file = "sim-out/var-m10/sim-result-50.Rdata")
```
