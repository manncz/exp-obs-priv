---
title: "Run Precision Simulations with Regression Estimator Changing P with Large Auxiliary Study"
...
#use_python("/Users/manncz/Library/r-miniconda/envs/r-reticulate/bin/python")
#py_install("DataSynthesizer", pip = T)
...
Run simulations in parallel. Simulating 100 new datasets (RCT and obs) and for each simulation 1,000 treatment effect vectors.
...
system.time({
  sim.list.10 <- sim_wrapper(n.obs = 10000, n.rct = 100,
                             ...
                             n.sim.dat=ndat, n.sim.treat=nsimt, tau=.5, syn.dp = T,
...
save(sim.list.10, file = "sim-out/var-m/sim-result-raw-10.Rdata")
save(out.p10, noise.p10, gmse.p10, file = "sim-out/var-m/sim-result-10.Rdata")
```
...
save(sim.list.20, file = "sim-out/var-m/sim-result-raw-20.Rdata")
save(out.p20, noise.p20, gmse.p20, file = "sim-out/var-m/sim-result-20.Rdata")
```
...
save(sim.list.50, file = "sim-out/var-m/sim-result-raw-50.Rdata")
save(out.p50, noise.p50, gmse.p50, file = "sim-out/var-m/sim-result-50.Rdata")
```
